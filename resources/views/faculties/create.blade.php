...
<div class="card">
    <div class="card-body">
       <h5 class="card-title">Faculty Form</h5>
       <form class="row g-3" method="POST" action="{{ route('faculties.store') }}">
        @csrf
          ...
          <div class="col-12"> <label for="description" class="form-label">Description</label> <input type="text" class="form-control" name="description"></div>
